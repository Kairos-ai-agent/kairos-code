...
path — `C:\\Users\\you\\AppData\\Local\\hermes\\skills\\...` — which is exactly
...
agent and the path within it.
    ...
    C:\\Users\\you\\AppData\\Local\\hermes\\skills\\.archive\\foo\\SKILL.md
      -> hermes/skills/.archive/foo/SKILL.md
    C:\\Users\\you\\.claude\\plugins\\marketplaces\\claude-plugins-official\\...
...
def to_relative(raw: str) -> str:
    """`C:\\\\Users\\\\you\\\\...` (as written in YAML) -> a portable path."""
...
def main() -> int:
    ...
    for path in sorted(root.rglob("*")):
        ...
        for line in lines:
            ...
            if m and ("you" in m.group(2) or "D_bak" in m.group(2)):
