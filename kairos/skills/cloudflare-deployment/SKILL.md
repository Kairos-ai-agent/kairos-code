...
source-path: "C:\\Users\\leohu\\AppData\\Local\\hermes\\skills\\.archive\\cloudflare-deployment\\SKILL.md"
---
...
User's projects (e.g. `C:\Users\leohu\D\ImageGen\`, `C:\Users\leohu\D\ShortDramaForge\`) all have a `deploy.py` or `deploy_full.py` near the root. Inside it you'll find:
...
PROJ = r'C:\Users\leohu\D\ImageGen'
