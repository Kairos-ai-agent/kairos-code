...
source-path: "C:\\Users\\you\\AppData\\Local\\hermes\\skills\\.archive\\ai-image-saas-on-cloudflare\\SKILL.md"
---
...
```bash
A=$(python -c "import json; print(json.load(open(r'C:\Users\you\D\ImageGen\_secrets.json'))['ADMIN_SECRET'])")
```
...
with open(r'C:\Users\you\D\ImageGen\.deploy_token') as f:
    TOKEN=f.read().strip()
