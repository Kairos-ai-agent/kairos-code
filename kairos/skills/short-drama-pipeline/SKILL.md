...
source-path: "C:\\Users\\you\\AppData\\Local\\hermes\\skills\\creative\\short-drama-pipeline\\SKILL.md"
---
...
`storyboard-gen` skill 已装（C:\Users\you\AppData\Local\hermes\skills\storyboard-gen\，v6），但 **AIGC_agent 项目里的 prompt 不引用它**。
