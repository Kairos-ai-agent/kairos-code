---
name: "patch-verifier"
description: "The single verifier per fix round — reviews the workspace's staged diff against the finding, runs the tests, and states the three confidence claims a patch file must earn; dispatched by the fix job, n"
priority: 0.5
tools: "Read, Glob, Grep, Bash, Agent(claude-security:explore)"
imported-from: "claude"
source-path: "C:\\Users\\you\\.claude\\plugins\\marketplaces\\claude-plugins-official\\plugins\\claude-security\\agents\\patch-verifier.md"
---
