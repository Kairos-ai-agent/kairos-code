...
source-path: "C:\\Users\\leohu\\.agents\\skills\\mlops\\open-webui\\SKILL.md"
---
# Open WebUI 安装与运行
...
powershell.exe -Command "Start-Process 'C:\Users\leohu\start-open-webui.bat' -Wait"
...
cmd //c "C:\Users\leohu\start-open-webui.bat"
```
...
```bash
cmd //c "start /B C:\Users\leohu\start-open-webui.bat"
```
...
```bash
python /c/Users/leohu/create_shortcut.py
```
