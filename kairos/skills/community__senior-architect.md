...
priority: 0.6
when:
  keyword: ['skill', 'used', 'asks', 'design', 'system', 'architecture']
---
...
Upstream: https://github.com/alirezarezvani/claude-skills/tree/main/engineering-team/skills/senior-architect
